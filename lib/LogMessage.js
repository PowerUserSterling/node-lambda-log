...
class LogMessage {
     ...
     */
    get value() {
        return Object.assign({ [this.levelField]: this.level, [this.messageField]: this.msg }, this.meta,
							 this.tagsField ? { [this.tagsField]: this.tags } : {});
    }
